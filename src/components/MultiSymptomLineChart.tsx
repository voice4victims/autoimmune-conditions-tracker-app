...
interface MultiSymptomLineChartProps {
  data: SymptomRating[];
  selectedSymptoms: string[];
}

const MultiSymptomLineChart: React.FC<MultiSymptomLineChartProps> = ({ data, selectedSymptoms }) => {
...
export default MultiSymptomLineChart;